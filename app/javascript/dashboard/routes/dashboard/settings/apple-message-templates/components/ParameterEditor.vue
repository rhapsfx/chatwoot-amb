...
const defaultLabel = t('TEMPLATES.BUILDER.PARAMETERS.DEFAULT.LABEL');
const exampleLabel = t('TEMPLATES.BUILDER.PARAMETERS.EXAMPLE.LABEL');
...
<template>
  <div class="space-y-6">
      ...
      >
        <div class="flex-1">
          <div class="flex items-center gap-3 mb-2">
            ...
            >
              {{ t('TEMPLATES.BUILDER.PARAMETERS.REQUIRED.BADGE') }}
            </span>
          </div>
          ...
          <div class="flex gap-4 text-xs text-n-slate-10">
            ...
            <div v-if="param.example">
              <span class="font-medium">{{ exampleLabel }}:</span>
              <code class="ml-1 px-1 bg-n-slate-2 rounded">{{
                param.example
              }}</code>
            </div>
    ...
    <!-- Add/Edit Modal -->
    <woot-modal v-model:show="showAddModal" @close="closeModal">
      <div class="w-full max-w-2xl p-6">
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <p class="mt-1 text-xs text-n-slate-10">
              {{ t('TEMPLATES.BUILDER.PARAMETERS.NAME.HINT') }}
            </p>
          </div>
        ...
        <div class="flex justify-end gap-3 mt-6">
          <Button variant="outline" slate @click="closeModal">
            {{ t('TEMPLATES.BUILDER.PARAMETERS.CANCEL') }}
          </Button>
          <Button @click="saveParameter">
            {{
              editingParameter
                ? t('TEMPLATES.BUILDER.PARAMETERS.UPDATE')
                : t('TEMPLATES.BUILDER.PARAMETERS.ADD')
            }}
          </Button>
        </div>
