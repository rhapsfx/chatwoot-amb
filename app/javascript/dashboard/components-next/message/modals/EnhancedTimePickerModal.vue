...
import SharedImageSelector from 'dashboard/routes/dashboard/settings/apple-message-templates/components/SharedImageSelector.vue';
  ...
  while (currentSlot < endTime) {
    ...
    if (slotEnd <= endTime) {
      ...
      slots.push({
        ...
        utcTime: format(
          zonedTimeToUtc(currentSlot, props.timezone),
