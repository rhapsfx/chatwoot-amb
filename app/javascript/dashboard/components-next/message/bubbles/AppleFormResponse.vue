    ...
    <div class="apple-form-response max-w-md">
      ...
      >
        <div class="flex items-start gap-2">
          ...
          <div>
            ...
            >
              {{ $t('APPLE_MESSAGES.FORM_RESPONSE.ERROR_LOADING') }}
            </p>
      ...
      >
        <p class="text-xs text-slate-600 dark:text-slate-400">
          {{ $t('APPLE_MESSAGES.FORM_RESPONSE.NO_RESPONSES') }}
        </p>
      </div>
      ...
      <div v-if="formattedResponses.length > 3" class="mt-2 text-center">
        ...
        >
          {{
            showAll
              ? $t('APPLE_MESSAGES.FORM_RESPONSE.SHOW_LESS')
              : $t('APPLE_MESSAGES.FORM_RESPONSE.SHOW_ALL', {
