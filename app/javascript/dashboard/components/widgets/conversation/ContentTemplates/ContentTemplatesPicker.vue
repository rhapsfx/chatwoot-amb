            ...
            <div class="flex justify-between items-center mb-2.5">
              <div class="flex items-center gap-2">
                ...
                <span
                  ...
                  :title="t('CONTENT_TEMPLATES.PICKER.UNIFIED_TEMPLATE')"
                >
                  {{ t('CONTENT_TEMPLATES.PICKER.UNIFIED_TEMPLATE') }}
                </span>
              </div>
            ...
            <div class="flex justify-between items-center mt-3">
              ...
              >
                <span class="font-medium">{{
                  t('CONTENT_TEMPLATES.PICKER.CHANNELS_COUNT', {
                    count: template.supportedChannels.length,
                  })
                }}</span>
              </div>
      ...
      <div v-if="!filteredTemplateMessages.length" class="py-8 text-center">
        <div v-if="isLoadingUnified || isRefreshing" class="space-y-2">
          ...
          <p class="text-n-slate-11">
            {{ t('CONTENT_TEMPLATES.PICKER.LOADING') }}
          </p>
        </div>
        <div
          v-else-if="
