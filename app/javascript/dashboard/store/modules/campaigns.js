...
export const getters = {
  ...
  getAppleMessagesCampaigns: (_state, _getters) => {
    const appleChannelTypes = [INBOX_TYPES.APPLE_MESSAGES_FOR_BUSINESS];
    return _getters.getCampaigns(CAMPAIGN_TYPES.ONE_OFF, appleChannelTypes);
  },
