...
new_base_url = 'https://mac-studio.tail367da4.ts.net'
...
begin
  ...
  puts '   Note: This is a permanent URL that works for all MSP IDs'
  puts '   Apple will send the business_id in the destination-id header'
