...
# This script installs Claude Code slash commands from the toolkit repository or registered template sources
# Requirements: bash
...
show_help() {
    show_template_help "$TEMPLATE_TYPE_COMMANDS" "claude-slash"
}
...
validate_arguments() {
    validate_template_arguments "$TEMPLATE_TYPE_COMMANDS"
}


# Main function
main() {
    template_main "$TEMPLATE_TYPE_COMMANDS" "$@"
}
